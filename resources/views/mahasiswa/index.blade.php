        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500">{{ $mhs->alamat ?? '-' }}</td>
                ...
                <tr>
                    <td colspan="5" class="px-6 py-8 text-center text-gray-500">
                        ...
                        <a href="{{ route('mahasiswa.create') }}" class="text-blue-500 hover:text-blue-600 mt-2 inline-block">+ Tambah data pertama</a>
                    </td>
                </tr>
                @endforelse
            </tbody>
