        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-500">{{ $dsn->alamat ?? '-' }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex justify-end gap-2">
                            <a href="{{ route('dosen.show', $dsn->nip) }}"
                            ...
                            <a href="{{ route('dosen.edit', $dsn->nip) }}"
                            ...
                            <form action="{{ route('dosen.destroy', $dsn->nip) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                ...
                <tr>
                    <td colspan="5" class="px-6 py-8 text-center text-gray-500">
                        ...
                        <a href="{{ route('dosen.create') }}" class="text-blue-500 hover:text-blue-600 mt-2 inline-block">+ Tambah data pertama</a>
                    </td>
                </tr>
                @endforelse
            </tbody>
