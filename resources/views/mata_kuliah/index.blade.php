        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $mk->matkul }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $mk->sks }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $mk->smt }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex justify-end gap-2">
                            ...
                            <a href="{{ route('mata-kuliah.edit', $mk->kode) }}"
                            ...
                            <form action="{{ route('mata-kuliah.destroy', $mk->kode) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                ...
                <tr>
                    <td colspan="6" class="px-6 py-8 text-center text-gray-500">
                        ...
                        <a href="{{ route('mata-kuliah.create') }}" class="text-blue-500 hover:text-blue-600 mt-2 inline-block">+ Tambah data pertama</a>
                    </td>
                </tr>
                @endforelse
            </tbody>
